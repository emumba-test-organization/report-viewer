...
import type { CognitiveFactorsSummaryData } from "./types";
...
export const OverviewBlock = React.forwardRef<
  HTMLDivElement,
  BlockProps<CognitiveFactorsSummaryData>
>(({ data, blockId, setRef }, ref) => {
...
export const CognitiveFactorsSummaryTitleBlock = React.forwardRef<
  HTMLDivElement,
  BlockProps
>(({ blockId, setRef }, ref) => (
  <div
...
export const CognitiveFactorsSectionBlock = React.forwardRef<
  HTMLDivElement,
  BlockProps
          ...
          <div className="p-2">
            <div className="flex flex-wrap gap-1">
              {section.factors.map((factor: any, idx: any) => (
                ...
                >
                  {Icon && (
                    <Icon size={5} className={`w-4 h-4 ${iconColorClass}`} />
                  )}
                  {factor}
                </Badge>
              ))}
